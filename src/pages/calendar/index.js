...
export default function CalendarPage() {
  return (
    ...
    <main>
			{/* <!-- CALENDER --> */}
			<section className="bg-light-green p-3">
				<div className="container bg-very-light-green rounded-4 py-3 p-4">
					<div className="calender-sections d-flex flex-column">
						<div className="calender-head d-flex justify-content-between align-items-center py-3 position-relative">
							<button type="button" className="btn border-0"><i className="fa-solid fa-chevron-right"></i></button>
							<div className="calender-header d-flex flex-column gap-2 position-relative">
								<div className="selected-date-type d-flex align-items-center">
									<button className="dropdown btn btn-show-months border-0" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									...
									<span className="text-center fw-bolder">محرم - صفر - 1445</span>
												...
												<form action="" encType="multipart/form-data">
													<div className="d-flex rounded-pill">
														<div className="d-flex rounded-pill w-100">
															...
															<button type="button"
																	className="icon-search btn p-2 rounded-0 rounded-end-4 bg-very-light-green"><i
							...
							<button type="button" className="btn border-0"><i className="fa-solid fa-chevron-left"></i></button>
						</div>
						<div className="calender-content shadow-light d-flex flex-column gap-3 p-3 px-4 mb-3 rounded-4">
							<div className="calender-weekdays bg-light-green d-flex justify-content-between gap-1 row flex-nowrap rounded-4">
								<button type="button" className="day btn col">ش</button>
								<button type="button" className="day btn col">ی</button>
								<button type="button" className="day btn col">د</button>
								<button type="button" className="day btn col">س</button>
								<button type="button" className="day btn col">چ</button>
								<button type="button" className="day btn col">پ</button>
								<button type="button" className="day btn col">ج</button>
							</div>
							<div className="days d-flex flex-column gap-1">
								<div className="d-flex justify-content-between gap-1 row flex-nowrap rounded-4">
									<button type="button" className="day btn col disable-days disabled">
                                    <span className="d-flex flex-column">
                                        <span className="shamsi-date date-font">29</span>
                                        <span className="other-date d-flex justify-content-evenly">
                                            <span className="miladi-date other-date-font disable-days">14</span>
                                            <span className="ghamari-date other-date-font disable-days">8</span>
                                        </span>
                                    </span>
									</button>
									<button type="button" className="day btn col disable-days disabled">
                                    ...
                                    <span className="d-flex flex-column">
                                        ...
                                        <span className="other-date d-flex justify-content-evenly">
                                            <span className="miladi-date other-date-font">14</span>
                                            <span className="ghamari-date other-date-font">8</span>
                                        </span>
                                    </span>
									</button>
								...
								<div className="d-flex justify-content-between gap-1 row flex-nowrap rounded-4">
									...
									<button type="button" className="day btn col auspicious-day" data-bs-toggle="modal" data-bs-target="#staticModalBackdrop">
                                    <span className="d-flex flex-column">
									...
									<div className="modal fade" id="staticModalBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
										<div className="modal-dialog modal-dialog-centered modal-dialog-scrollable justify-content-center">
											<div className="modal-content">
												<div className="modal-header align-items-center">
													<h2 className="modal-title fs-6 text-brown fw-bolder" id="staticBackdropLabel">اعمال الخاصة في لیلة 9 من محرم</h2>
													<button type="button" className="btn-close p-1 m-0" data-bs-dismiss="modal" aria-label="Close"></button>
												</div>
						...
						<div className="go-today">
							<button type="button" className="btn-today btn w-100 shadow-very-light">برو به امروز</button>
						</div>
					</div>
				</div>
			</section>
			...
			{/* <!-- EVENTS --> */}
			<section className="actions-calender bg-actions pt-2 pb-4 border-top-1">
				<div className="actions-container container">
					<div className="head-of-actions">
						<h2 className="text-color-prayers py-3 mb-0">اعمال الیوم الأربعاء</h2>
					</div>
					<ul className="actions-calender">
						...
						<li className="actions-for-days-of-the-week align-items-center event-holiday fs-5">
							<p className="d-inline-block m-0">احیاء</p>
						</li>
					</ul>
				</div>
